...
def sophia_about_callback(update, context):
    ...
    if query.data == "sophia_":
        query.message.edit_text(
            text=""" My name is *🇨𝐫𝐢𝐬𝐭𝐢𝐚𝐧𝐨 🇷𝐨𝐧𝐚𝐥𝐝𝐨*, I have been written with Pyrogram and Telethon.. I'm online since 26 April 2022 and is constantly updated!
*Bot Version: 3.0*
\n*Bot Developers:*
-  @Suryaakumar
-  @bestie_of_suryaa_parzi
...
* Support Chat:* @Friendstamilchatting
                 ...
                 \n© 2020 - 2021 @Zaynmalik_gc_bot. All Rights Reserved """,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
